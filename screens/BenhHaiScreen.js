...
const BenhHaiScreen = ({navigation, route}) => {
  ...
  const arrayCachTriBenh = [
    'Tạo thông thoáng cho vườn (mật độ cây trồng hợp lý, tỉa cành tạo tán), Cắt tỉa và tiêu hủy các lá, cành, trái bị bệnh, Không nên tưới nước lên tán cây khi cây bị bệnh.',
    ...
    'Phải sử dụng bao trái,Tạo thông thoáng cho vườn (mật độ cây trồng hợp lý, tỉa cành tạo tán).',
    ...
    'Tạo thông thoáng cho vườn (mật độ cây trồng hợp lý, tỉa cành tạo tán),Cắt bỏ và tiêu hủy các nhánh nhiễm bệnh.',
    'Phải sử dụng bao trái, Không nên phun nước lên lá xoài khi cây bị bệnh để tránh lây lan bệnh ra cả vườn,  Bảo tồn thiên địch để hạn chế nhện đỏ và bù lạch.',
    '',
  ];
  const PhongbenhValue = () => {
    let data = '';
    if (selectedValue === 'thanthu') {
      data = arrayCachTriBenh[0];
    }
    if (selectedValue === 'thoitrai') {
      data = arrayCachTriBenh[1];
    }
    if (selectedValue === 'daech') {
      data = arrayCachTriBenh[2];
    }
    if (selectedValue === 'phantrang') {
      data = arrayCachTriBenh[3];
    }
    if (selectedValue === 'namhong') {
      data = arrayCachTriBenh[4];
    }
    if (selectedValue === 'ximutrai') {
      data = arrayCachTriBenh[5];
    }
    return data;
  };
  const setNameBenh = (value) => {
    let data = '';
    if (value === 'thanthu') {
      data = 'Bệnh Thán thư';
    }
    if (value === 'thoitrai') {
      data = 'Bệnh Thối trái, khô đọt';
    }
    if (value === 'daech') {
      data = 'Bệnh da ếch';
    }
    if (value === 'phantrang') {
      data = 'Bệnh phấn trắng';
    }
    if (value === 'namhong') {
      data = 'Bệnh nấm hồng';
    }
    ...
    <View style={styles.container}>
      ...
      <Animated.View
        ...
        <View style={styles.footer}>
          <View>
            <ScrollView
            //style={{display: selectedValue === '' ? 'none' : 'flex'}}
            >
              <View>
                <Text style={{color: '#009387', fontSize: 16, marginBottom: 5}}>
                  Chọn bệnh cây đang bị
                </Text>
                <RNPickerSelect
                  placeholder={{}}
                  onValueChange={(value) => {
                  ...
                  items={[
                    ...
                    {label: 'Bệnh Thán thư', value: 'thanthu'},
                    {label: 'Bệnh Thối trái, khô đọt', value: 'thoitrai'},
                    {label: 'Bệnh da ếch', value: 'daech'},
                    {label: 'Bệnh phấn trắng', value: 'phantrang'},
                    {label: 'Bệnh nấm hồng', value: 'namhong'},
                    {label: 'Bệnh xì mủ trá', value: 'ximutrai'},
                  ]}
                  value={selectedValue}
                />
              </View>
              ...
              <Modal
                ...
                <View style={([styles.container], {borderRadius: 30})}>
                  <Text style={styles.text_header}>{PhongbenhValue()}</Text>
                  <View
                    style={[
                      styles.button,
                      {
