  ...
  },
  {
    ...
    type: {
      ...
      "Rầy bông xoài" : [
        ...
        ["Tỉa cành tạo điều kiện thông thoáng để hạn chế sự phát triển của rầy.","Cách phòng trị"]
      ],
      "Rệp sáp" : [
        ...
        ["- Bảo tồn thiên địch như: ong ký sinh và bọ rùa ... để hạn chế rệp sáp.","- Phun thuốc hóa học như : dầu khoáng DS 98.8 EC, Admire 050 EC, Supracide 40 EC."]
      ],
      "Ruồi đục quả xoài" : [
